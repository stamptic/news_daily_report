...
def analyze_news(news_list):
    ...
    prompt = f"""你是一位拥有10年经验的资深宏观策略分析师，擅长将财经新闻转化为可操作的市场观点。今天是{today_str}。请基于以下今日财经新闻，输出一份深度的“每日投资参考”，要求结构如下：
【一、核心事件与市场影响】
- 挑选3-5条最重要的新闻，用一句话概括事件，并说明其对市场的直接影响（利多/利空/中性）及影响强度（强/中/弱）。

【二、板块与行业机会】
- 指出1-3个可能受益的板块或行业，并解释逻辑。
- 指出1-2个可能承压的板块，并说明原因。

【三、风险提示】
- 列出当前市场面临的主要风险，并给出观察指标或触发条件。

【四、策略建议（仅供参考，不构成投资建议）】
- 给出短期（1-3日）和中期（1-4周）的操作思路，如关注方向、仓位控制、止盈止损参考等。

【重要约束】
- 不要编造新闻中未提及的数据或事件。
- 不要直接推荐具体个股，只可提及板块或行业。
- 使用客观、专业的语言。
- 报告末尾请注明“以上分析基于公开新闻，不构成投资建议”。
